...
int main(int argc, char *argv[])
{
    ...
    *********************************************/
    double IPD = 0.065;
    double PWMStep2Rad = 0.113 * (3.14/180);
    double al = 0;
    double ar = 0;
...
*********************************************/
        ...
        al = (Lx - LxC) * PWMStep2Rad;
        ar = (RxC - Rx) * PWMStep2Rad;

        double Dl = (IPD*cos(ar))/sin(al+ar);
        double Dc = sqrt(pow(Dl, 2) + pow(IPD, 2)/4 - Dl*IPD*sin(al));
        printf("Dc = %f\n\r", Dc);
